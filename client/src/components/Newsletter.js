     ...
     <div className='mx-auto grid lg:grid-cols-3'>
        ...
        <div className='my-4'>
            <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
                ...
                <button className='bg-[#00df9a] text-white rounded-md font-medium w-[200px] ml-4 mr-4 my-6 px-6  border-none' >
                    Notify me
                </button>
                <p>We are concerned about the security of your data, Read{""}</p><span className='text-[#00df9a]'>Privacy Policy</span>
            </div>
